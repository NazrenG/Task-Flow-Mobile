...
//   return (
//     <View className=" rounded-xl shadow shadow-slate-300 px-2 py-3 mb-3 flex-row items-center justify-between  " style={{ backgroundColor: Colors[theme].card }}>
    ...
    <View className="bg-white rounded-xl shadow shadow-slate-300 px-2 py-3 mb-3 flex-row items-center justify-between">
      <View className="flex-row items-start space-x-3 w-[70%] gap-1">
        ...
        <View className="flex-col">
          <Text className="font-semibold text-gray-800" style={{ color: Colors[theme].text }}>{user.name}</Text>
