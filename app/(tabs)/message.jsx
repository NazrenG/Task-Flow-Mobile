    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <Text style={{ fontSize: 20, fontWeight: "600", color: Colors[theme].text }}>
              {t("chat.message")}
            </Text>
          </View>
            ...
            <View style={{ padding: 12 }}>
              <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                ...
                >
                  ...
                  <Text style={{ color: Colors[theme].textSecondary }}>hello!</Text>
                </Pressable>
                <View style={{ alignItems: "flex-end" }}>
                  <Pressable onPress={() => {}}>
                    <Entypo name="dots-three-vertical" size={20} color={Colors[theme].icon} />
                  </Pressable>
                  <Text style={{ color: Colors[theme].textSecondary, marginTop: 6 }}>
                    6/12/2025
                  </Text>
                </View>
              </View>
          ...
          >
            ...
            >
              ...
              <View style={{ flexDirection: "row", justifyContent: "space-around", width: "100%" }}>
                <Pressable onPress={() => Linking.openURL("mailto:example@email.com")}>
                  <Entypo name="mail" size={24} color={Colors[theme].icon} />
                </Pressable>
                <View style={{ width: 1, height: 28, backgroundColor: Colors[theme].icon }} />
                <Pressable onPress={() => Linking.openURL("tel:+123456789")}>
                  <MaterialIcons name="call" size={24} color={Colors[theme].icon} />
                </Pressable>
                <View style={{ width: 1, height: 28, backgroundColor: Colors[theme].icon }} />
                <Pressable
                  onPress={() => {
                ...
                >
                  <AntDesign name="message1" size={24} color={Colors[theme].icon} />
                </Pressable>
              </View>
            </Pressable>
          </Pressable>
