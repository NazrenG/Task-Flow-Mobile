  ...
  return (
    <>
      ...
      <SafeAreaView className="flex-1 bg-gray-50">
        ...
        >
          <View
            className="flex-row flex-wrap justify-between items-center w-full rounded-lg bg-white shadow-sm p-4 mx-4 gap-2 mb-2"
            style={{ backgroundColor: Colors[theme].card }}
          >
            <Card
        ...
        >
          ...
          >
            ...
            <View
              className="flex-row flex-wrap justify-end flex-1 ml-4"
              style={{ backgroundColor: Colors[theme].background }}
            >
              {statusFilters.map((s) => (
                <TouchableOpacity
