...
const ProjectPage = () => {
  ...
  // 🔹 1. Burada state-ləri string yox, array kimi initialize etdim
  ...
  useEffect(() => {
    const getDatas = async () => {
      try {
        ...
        // 🔹 2. Gələn dataları state-ə yazıram
      ...
      <ScrollView contentContainerStyle={{ alignItems: "center", padding: 10 }}>
        ...
        >
          ...
          <Card
            ...
            // 🔹 3. Burada ?.length ?? 0 qoydum ki, undefined olsa da error verməsin
            count={complatedProjectCount?.length ?? 0}
          ...
          <Card
            ...
            count={onGoingProjectCount?.length ?? 0}
          ...
          <Card
            ...
            count={pendingProjectCount?.length ?? 0}
